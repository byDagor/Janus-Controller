...
<img src="Images/JC20.01-Features.PNG" width=300 align=left>
...
To demonstrate how a low KV motor produces more torque than a higher KV we can take the torque equation and substitute the variables. We are going to imagine we have two motors with an internal resistance of 11.3 ohms and we are going to drive both at 5V, but one has a KV of 140 and the other has a KV of 660.
![TorqueCalc](Images/TorqueCalc.PNG)
